    ...
    return (
        <div className="flex-1 p-6 relative z-10">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-2xl font-semibold text-gray-800">Tus Contraseñas</h1>
                ...
                <div className="mt-6 bg-white shadow-md rounded-lg p-5 transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg backdrop-blur-md bg-opacity-90">
                    ...
                    <ul className="mt-4 space-y-3">
                        {passwords.map((password) => (
                            <li key={password.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                <div>
