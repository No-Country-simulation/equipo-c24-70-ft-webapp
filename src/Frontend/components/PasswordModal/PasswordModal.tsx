...
const PasswordModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    const savePassword = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/passwords`, {
                method: "POST",
                headers: {
            ...
            <div className="bg-white w-[500px] p-6 rounded-lg shadow-lg relative">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="space-y-3">
                        <div>
                            <label className="block text-gray-700 text-sm font-medium">URL:</label>
                            <input
                                type="text"
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="w-1/3">
                                <label className="block text-gray-700 text-sm font-medium">Carpeta:</label>
                                <input
                                    type="text"
                                    className="w-full border rounded p-2 text-gray-800"
                                    value={folder}
                        ...
                        <div className="flex gap-2">
                            <div className="w-1/2">
                                <label className="block text-gray-700 text-sm font-medium">Nombre de usuario:</label>
                                <input
                                    type="text"
                                    className="w-full border rounded p-2 text-gray-800"
                                    value={username}
                            ...
                            <div className="w-1/2">
                                <label className="block text-gray-700 text-sm font-medium">Contraseña del sitio:</label>
                        ...
                        <div>
                            <label className="block text-gray-700 text-sm font-medium">Notas:</label>
                            <textarea
