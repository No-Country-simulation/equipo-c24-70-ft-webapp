...
const ImportPasswordModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[9999]">
            <div className="bg-white w-[500px] p-6 rounded-lg shadow-lg relative">
                ...
                <div className="space-y-3">
                    <div>
                        <label className="block text-gray-700 text-sm font-medium">Selecciona el archivo:</label>
                        <input 
                            type="file" 
                    ...
                    <div>
                        <label className="block text-gray-700 text-sm font-medium">Formato del archivo:</label>
                        <select 
                            className="w-full border rounded p-2 text-gray-800"
                        >
