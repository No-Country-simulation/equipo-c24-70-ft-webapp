...
function TalkBanner() {
  return (
    <section className="container py-12" id="talk-banner">
      <article className="background__accent-purple relative p-8 flex flex-col justify-center items-center min-h-80 rounded-2xl">
