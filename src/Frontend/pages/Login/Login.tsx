...
const Login = () => {
  ...
  return (
    <div className="login flex items-center justify-center min-h-screen relative group px-4">
      ...
      />
      <div className="relative w-full max-w-md rounded-lg bg-white p-6 shadow-md backdrop-blur-md bg-opacity-90 
      transition-transform duration-300 group-hover:-translate-y-2 group-hover:shadow-lg">
        <h2 className="mb-4 text-center text-2xl font-semibold">Inicio de sesión</h2>
